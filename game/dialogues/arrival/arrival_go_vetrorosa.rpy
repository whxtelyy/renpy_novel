label arrival_go_vetrorosa:
    ...
    sp "Нет, это действительно подходит! Там ведь всегда было связано с обучением и знаниями."
    ...
    sp "Багио, ты серьёзно? Ты не видишь, что тут вообще нет двери? Хотя... не удивительно, это же ты."
