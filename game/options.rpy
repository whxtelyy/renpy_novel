...
define config.name = _("Inside the Code")
...
define gui.about = _p("""
Добро пожаловать в "Внутри кода: Frontend" - увлекательную визуальную новеллу, которая погружает вас в мир фронтенд-разработки!
Вы - Эмрах, офисный работник, который решил связать свою жизнь с IT. 
Вместе с ним вы отправитесь в неожиданное путешествие и узнаете, что значит быть фронтенд-разработчиком! \n

Команда "Код сюжета": \n
Исаев Савелий - Тимлид, аналитик \n
Дмитрий Шкарбун - Геймдизайнер-сценарист \n
Еманова Анастасия - Дизайнер \n
Артюхин Максим - Разработчик \n

Игровой курсор сделан Andrean Prawobo на сайте www.flaticon.com \n
Иконка хорошей концовки сделана iconixar на сайте www.flaticon.com \n
Иконка плохой концовки сделана Freepik на сайте www.flaticon.com \n
Иконка достижения "Настоящий разработчик" сделана iconixar на сайте www.flaticon.com \n
Иконка достижения "Любопытный" сделана zafdesign на сайте www.flaticon.com \n
""")
...
define build.name = "InsidetheСode"
...
define config.save_directory = "Codeofplot-1729884419"
