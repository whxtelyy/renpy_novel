...
define gui.about = """
Добро пожаловать в игру "Внутри кода" - увлекательная визуальная новелла, которая погрузит вас в мир фронтенд-разработки!
...
Команда "Код сюжета":
Тимлид: Исаев Савелий
Геймдизайнер-сценарист: Дмитрий Шкарбун, Артюхин Максимилиан
Дизайнер: Еманова Анастасия
Разработчик: Артюхин Максимилиан, Исаев Савелий
Аналитик: Исаев Савелий
"""
...
define config.save_directory = "InsideTheСode-1729884419"
